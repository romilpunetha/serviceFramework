...
import com.services.sf.sql.outbox.OutboxEntity;
import com.services.sf.sql.outbox.OutboxRepository;
import com.services.sf.test.sql.dummy.Dummy;
import com.services.sf.test.sql.dummy.DummyService;
...
public class TestSqlDummy {
    ...
    private static final String tenantIdToUse = "df-testing";
    ...
    public void destroyEach() {
        outboxRepository.deleteAll().await().indefinitely();
    }
    ...
    public void testCreate() {
        var dummy = Dummy.builder().hello("testCreate").someOtherStuff("otherStuff").build();
