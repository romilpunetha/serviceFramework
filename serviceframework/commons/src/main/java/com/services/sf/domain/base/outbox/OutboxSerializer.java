package com.services.sf.domain.base.outbox;
...
public class OutboxSerializer {
    ...
    public OutboxSerializer(@ConfigProperty(name = "outbox." + KafkaAvroSerializerConfig.SCHEMA_REGISTRY_URL_CONFIG, defaultValue = "http://localhost:8085") List<String> SCHEMA_REGISTRY_URL_CONFIG,
                            @ConfigProperty(name = "outbox." + KafkaAvroSerializerConfig.MAX_SCHEMAS_PER_SUBJECT_CONFIG, defaultValue = "1000") Integer MAX_SCHEMAS_PER_SUBJECT_CONFIG,
                            @ConfigProperty(name = "outbox." + KafkaAvroSerializerConfig.AVRO_REFLECTION_ALLOW_NULL_CONFIG, defaultValue = "true") boolean AVRO_REFLECTION_ALLOW_NULL_CONFIG,
                            @ConfigProperty(name = "outbox." + KafkaAvroSerializerConfig.AVRO_USE_LOGICAL_TYPE_CONVERTERS_CONFIG, defaultValue = "true") boolean AVRO_USE_LOGICAL_TYPE_CONVERTERS_CONFIG,
                            @ConfigProperty(name = "outbox." + KafkaAvroSerializerConfig.AVRO_REMOVE_JAVA_PROPS_CONFIG, defaultValue = "true") boolean AVRO_REMOVE_JAVA_PROPS_CONFIG,
                            @ConfigProperty(name = "outbox." + KafkaAvroSerializerConfig.NORMALIZE_SCHEMAS, defaultValue = "true") boolean NORMALIZE_SCHEMAS,
                            @ConfigProperty(name = "outbox." + KafkaAvroSerializerConfig.AUTO_REGISTER_SCHEMAS, defaultValue = "true") boolean AUTO_REGISTER_SCHEMAS,
                            @ConfigProperty(name = "outbox." + KafkaAvroSerializerConfig.SCHEMA_REFLECTION_CONFIG, defaultValue = "true") boolean SCHEMA_REFLECTION_CONFIG
    ) {
